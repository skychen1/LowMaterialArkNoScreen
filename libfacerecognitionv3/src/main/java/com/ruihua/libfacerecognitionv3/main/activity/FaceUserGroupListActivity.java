...
import com.ruihua.libfacerecognitionv3.main.listener.OnItemClickListener;
import com.ruihua.libfacerecognitionv3.main.listener.OnItemLongClickListener;
import com.ruihua.libfacerecognitionv3.main.manager.UserInfoManager;
import com.ruihua.libfacerecognitionv3.main.model.Group;
...
public class FaceUserGroupListActivity extends BaseActivity implements View.OnClickListener,
    ...
    public void onClick(View view) {
        int i1 = view.getId();// 根据关键字搜索用户组
// 返回上一级页面
// 批量操作or全选
// 删除
// 取消
        if (i1 == R.id.button_group_search) {
...
//            ToastUtils.toast(FaceUserGroupListActivity.this, "用户列表需要跳转");
        }
    }
