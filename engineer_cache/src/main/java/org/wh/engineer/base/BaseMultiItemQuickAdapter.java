...
public abstract class BaseMultiItemQuickAdapter<T extends MultiItemEntity, K extends BaseViewHolder> extends
   ...
   //  添加数据
   public void addData(int position,List<T> k) {
	//      在list中添加数据，并通知条目加入一条
	mData.addAll(position, k);
	//添加动画
